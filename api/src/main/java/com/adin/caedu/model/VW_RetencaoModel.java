...
@Entity(name = "VW_RETENCAO")
@Table(name = "VW_RETENCAO", schema = "crm")
public class VW_RetencaoModel {
	...
	public VW_RetencaoModel() {

	}

	public VW_RetencaoModel(String cPF, String nOME_COMPLETO, String gENERO, String dATA_NASCIMENTO,
